...
public class User {
    ...
    public int numDeliveriesPendingToDeliver() {
        ...
        for (Shipment s:
            ...
            if (s != null && s.getDeliveryDate() == null) shipmentDeliverPending++;
        }
    ...
    public boolean containsShipment(int idShipment){
        if (!shipments.isEmpty()) {
            for (Shipment s :
                    shipments) {
                if (s != null && s.getId() == idShipment) return true;
            }
        }
        return false;
    }
    ...
    public ArrayList<Shipment> shipmentsPendingToDelivery() {
        ...
        if (shipments.isEmpty()) return null;
            ...
            for (Shipment s:
                 shipments) {
                if (s != null && (s.getStatus().equals("En almacen") || s.getStatus().equals("En oficina de origen"))) shipmentsPendings.add(s);
            }
        }
